            ...
            {COMPETITION.categories.map((c) => {
              ...
              return (
                ...
                >
                  ...
                  {/*Wrapped buttons in container with space-y-4 for gap */}
                  <div className="space-y-4">
                    ...
                    {c.mapUrl && (
                      <button
                        onClick={() => window.open(c.mapUrl, '_blank')}
                        className="w-full rounded-full bg-[#D4AF37] text-white font-bold px-6 py-4 hover:bg-[#c4a133] transition shadow-md flex items-center justify-center gap-2"
                      >
