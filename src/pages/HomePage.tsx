...
export default function HomePage() {
  ...
  return (
    <div className="bg-white">
      ...
      {/* CONTENT */}
      <main className="mx-auto max-w-5xl px-4 sm:px-6 py-20 space-y-32">
        ...
        <section className="flex flex-col md:flex-row gap-12 md:gap-20 items-center">
          <div className="w-full md:w-2/5 flex justify-center md:justify-start">
            <img
              ...
              className="h-48 md:h-64 object-contain drop-shadow-sm"
            />
          </div>
          <div className="w-full md:w-3/5 space-y-6">
            <div>
              ...
              <p className="mt-3 text-lg text-[#001F3F]/60 font-medium">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 pt-8 mt-8 border-t border-gray-100">
              {HOME.about.makerFair.keyFacts.map((f) => (
                <div key={f.label} className={f.label === "Venues" ? "sm:col-span-2" : ""}>
                  <div className="text-xs font-bold text-gray-400 uppercase tracking-widest">{f.label}</div>
                  <div className="mt-1.5 font-medium text-gray-800">{f.value}</div>
                </div>
              ))}
            </div>
          </div>
        ...
        {/* --- 2. About Organizer --- */}
        <section className="flex flex-col md:flex-row-reverse gap-12 md:gap-20 items-center">
        ...
        {/* --- 3. Past Execution (Separated) --- */}
        <section className="bg-gray-50/50 rounded-[2.5rem] p-8 sm:p-12 border border-gray-100 relative overflow-hidden">
          ...
          <div className="max-w-3xl mx-auto text-center space-y-6">
            ...
            <div className="inline-flex items-center gap-2 bg-white px-5 py-2.5 rounded-full border border-gray-200 shadow-sm text-sm font-bold text-[#001F3F]">
              🏆 {HOME.about.organizer.pastExecution.stats?.[0].label}: {HOME.about.organizer.pastExecution.stats?.[0].value}
            </div>

            <div className="space-y-5 text-gray-600 text-lg leading-relaxed font-light text-left md:text-center mt-6">
          ...
          <div className="mt-12 rounded-2xl overflow-hidden shadow-lg border border-gray-200/50">
            {/* Using the group photo from the assets for the past execution section */}
            <img 
              src="/src/assets/Group-photo-Makerfair25.png" 
              alt="Past Execution 2025 Group Photo" 
        ...
        <section className="pt-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {/* Contributor */}
            <div className="rounded-3xl bg-blue-50/40 p-8 sm:p-10 transition hover:bg-blue-50/80">
              <div className="text-[#001F3F] font-extrabold text-2xl">
                Contributor Support
              </div>
              ...
              <div className="mt-8 pt-8 border-t border-blue-100">
                <div className="text-xs font-bold tracking-widest text-[#001F3F]/60 uppercase">
                  {HOME.contributor.role}
                </div>
                <div className="mt-1 text-lg font-bold text-[#001F3F]">
                ...
                <div className="mt-6 flex flex-col sm:flex-row gap-3">
                  ...
                  <button
                    ...
                    className="rounded-full bg-white text-[#001F3F] font-semibold px-6 py-3 hover:bg-gray-50 transition shadow-sm border border-gray-100"
                  >
                    Email
                  </button>
                </div>
            ...
            {/* Sponsor */}
            <div className="rounded-3xl bg-amber-50/40 p-8 sm:p-10 transition hover:bg-amber-50/80">
              <div className="text-[#001F3F] font-extrabold text-2xl">
                Event Sponsorship
              </div>
              <p className="mt-3 text-gray-600 leading-relaxed font-light">
