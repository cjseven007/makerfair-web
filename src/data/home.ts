export const HOME = {
  ...
  highlights: [
    {
      title: "Robotics & AI",
      description: "Hands-on experience with autonomous robots and artificial intelligence.",
    },
    {
      title: "Hands-on Learning",
      description: "Competitions that build practical engineering skills.",
    },
    {
      title: "Industry Exposure",
      description: "Connect with leading tech companies specializing in automation and IoT.",
    },
  ],
  contributor: {
  ...
  contacts: [
    { role: "Project Director", name: "Jonathan Voon Yen Jie", email: "yen_22011091@utp.edu.my" },
    { role: "Sponsorship & Partnerships", name: "Lim Ming Yang", email: "lim_24005921@utp.edu.my" },
    { role: "General Enquiries", name: "Geoffrey Lee Jin Yau", email: "geoffrey_24006190@utp.edu.my" },
  ],
  footer: {
